      ...
      <div className="max-w-6xl mx-auto px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-gray-600">
            Découvrez ce que nos clients pensent de nos services et trouvez-nous facilement
          </p>
        </div>
          ...
          <div>
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <div className="min-h-[400px] bg-white rounded-lg p-6 shadow-sm">
                <div className="elfsight-app-1e677fe2-468b-4851-9863-223c7ba6618e" data-elfsight-app-lazy></div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <div className="text-center mt-6 pt-6 border-t border-gray-200">
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600 text-sm">91700 Saint-Geneviève-des-Bois</p>
                </div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  ...
                  <p className="text-gray-600 text-sm">Note Google My Business</p>
                  <p className="text-xs text-gray-500 mt-1">319 interactions avec les clients</p>
                </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-black text-white p-8 rounded-lg max-w-2xl mx-auto">
            ...
            <p className="text-gray-400 text-sm mb-6">
              Prenez rendez-vous dès maintenant et découvrez pourquoi 
